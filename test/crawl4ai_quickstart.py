...
"""##### Setup Crawl4ai
The following command installs Playwright and its dependencies and updates a few configurations for Crawl4ai. After that, you can run the doctor command to ensure everything works as it should.
...
await extract_structured_data_using_llm("gemini/gemini-2.0-flash-001", os.getenv("GEMINI_API_KEY"))
